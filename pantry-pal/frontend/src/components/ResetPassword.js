...
import { Box, Button, TextField, Typography, IconButton, Snackbar, Alert } from "@mui/material";
...
export default function ResetPassword({ setActiveSection }) {
  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#f0f2f5" }}>
      <Box sx={{ padding: 4, maxWidth: "400px", width: "100%", backgroundColor: "white", borderRadius: 2 }}>
